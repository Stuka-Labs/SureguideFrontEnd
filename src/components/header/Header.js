...
function Header()
{
    ...
    return (
      ...
      {mobview?   <div className=' h-12 flex'>
        ...
        <div className='w-[17.45%] flex items-center justify-center border-r-[.1px] border-gray-400 bg-[#0073cf] h-full text-white text-[14px] lg:text-[16px] xl:text-[19px] 2xl:text-[22px] font-medium font-sofia text-center'> Sure Guide</div>
